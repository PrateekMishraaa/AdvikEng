        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="p-6 border rounded-lg shadow">
              {/* <h3 className="text-xl font-bold text-gray-800">Mr. Rajeev Mehta</h3> */}
            ...
            <div className="p-6 border rounded-lg shadow">
              {/* <h3 className="text-xl font-bold text-gray-800">Ms. Anjali Sharma</h3> */}
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="p-6 border rounded-lg shadow">
              {/* <h3 className="text-xl font-bold text-gray-800">Saurav Deshmukh</h3> */}
            ...
            <div className="p-6 border rounded-lg shadow">
              {/* <h3 className="text-xl font-bold text-gray-800">Ritika Menon</h3> */}
            ...
            <div className="p-6 border rounded-lg shadow">
              {/* <h3 className="text-xl font-bold text-gray-800">Mohammed Amaan</h3> */}
