    ...
    const details = [
        {
            ...
            description: `Vikash Mishra is heading the organization as Chairman and Managing Director.
        ...
        <>
            ...
            <section className="h-screen w-full">
                <Carousel
                    ...
                    className="h-full"
                >
                    {[Banner, BannerTwo, BannerThree].map((image, index) => (
                        <div key={index}>
                            <img
                                src={image}
                                alt={`Banner ${index + 1}`}
            ...
            {/* About Section */}
            <section className="w-full min-h-screen px-4 sm:px-6 md:px-12 lg:px-24 py-16 bg-white" ref={container}>
                <div className="max-w-6xl mx-auto text-center space-y-10">
                    <h2 className="text-3xl md:text-5xl font-semibold font-serif text-blue-600 hover:text-blue-800 transition cursor-pointer">
                        About <span className="text-black">Advik Engineering</span>
                    </h2>
                    <p className="text-sm md:text-base lg:text-lg font-sans text-gray-800 leading-relaxed">
                ...
                {details.map((item, index) => (
                    ...
                    >
                        <div className="md:w-1/2 space-y-4 text-center md:text-left">
                            <h3 className="text-2xl md:text-3xl font-semibold font-serif">{item.title}</h3>
